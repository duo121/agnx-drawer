...
export const STORAGE_ACCESS_CODE_KEY = "agnx-access-code"
const STORAGE_ACCESS_CODE_REQUIRED_KEY = "agnx-access-code-required"
...
function SettingsContent({
    ...
    return (
        <DialogContent container={container} className="sm:max-w-lg p-0 gap-0">
            {/* Header */}
...
export function SettingsDialog(props: SettingsDialogProps) {
    ...
    React.useEffect(() => {
        setContainer(document.getElementById('chat-panel-container'))
    }, [])
    ...
    return (
        <Dialog open={props.open} onOpenChange={props.onOpenChange}>
            <Suspense
                fallback={
                    <DialogContent container={container} className="sm:max-w-lg p-0">
            ...
            >
                <SettingsContent {...props} container={container} />
            </Suspense>
        </Dialog>
    )
}
