                ...
                {showMultiLineMode ? (
                    <>
                        ...
                        <div className="flex items-center gap-1 px-3 pb-3">
                            ...
                            {/* 引擎徽章 - 仅当选中了引擎 SKILL 时显示 */}
                            {(() => {
                                // 检查是否选中了引擎类 SKILL
                                const selectedEngineSkill = selectedSkillIds.has("drawio") ? "drawio" 
                                    : selectedSkillIds.has("excalidraw") ? "excalidraw" 
                                    : null
                                
                                if (!selectedEngineSkill) return null
                                ...
                                return (
                                    <button
                                        ...
                                        onClick={() => onSkillDeselect?.(selectedEngineSkill)}
                                        onMouseEnter={() => setIsEngineBadgeHovered(true)}
                                        onMouseLeave={() => setIsEngineBadgeHovered(false)}
                                        title={isEngineBadgeHovered ? "关闭引擎提示词" : (selectedEngineSkill === "drawio" ? "Draw.io 引擎" : "Excalidraw 引擎")}
                                    >
                                        {isEngineBadgeHovered ? (
                                            <X className="h-4 w-4" />
                                        ) : selectedEngineSkill === "drawio" ? (
