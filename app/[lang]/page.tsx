...
export default function Home() {
    ...
    const [darkMode, setDarkMode] = useState<boolean | null>(null) // 初始为 null，表示未加载
    ...
    useEffect(() => {
        ...
        const savedLocale = localStorage.getItem("agnx-locale")
        ...
        const savedDarkMode = localStorage.getItem("agnx-dark-mode")
        if (savedDarkMode !== null) {
            ...
            // 保存到 localStorage，下次启动时直接使用
            localStorage.setItem("agnx-dark-mode", String(prefersDark))
        }
    ...
    const handleDarkModeChange = () => {
        ...
        console.log('[DarkMode] Changing from', darkMode, 'to', newValue)
                                ...
                                <>
                                    ...
                                    >
                                        <DrawIoEmbed
                                            ...
                                            urlParameters={{
                                                ui: darkMode === true ? 'dark' : drawioUi,
                                                spin: false,
                                                libraries: false,
                                                saveAndExit: false,
                                                noSaveBtn: true,
